              ...
              <div className="container mx-auto px-4"> 
                <div className="flex items-center justify-between h-16">
                  ...
                  <div className="hidden md:flex items-center space-x-4">
                    <Link href = {GOOGLE_AUTH_URL} className="px-4 py-2 text-[#00A674] hover:text-[#008c61] transition-colors">
                      Log In
                    </Link>
                    <Link href = {GOOGLE_AUTH_URL} className="px-4 py-2 bg-[#00A674] text-white rounded-md hover:bg-[#008c61] transition-colors">
                      Sign Up
                    </Link>
                  </div>
                  {/* Mobile Menu Button */}
