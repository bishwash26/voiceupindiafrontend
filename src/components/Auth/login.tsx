...
export const LoginPage = ({isLogin=true}) => {
          ...
          <div className="w-full flex-1 mt-8">
            ...
            <div className="mx-auto max-w-xs">
             ...
             <p className="mt-6 text-xs text-gray-600 text-center">
                ...
                <a href="/register" className="border-b text-[#00A674] font-bold">
                 Join the mission
                </a>
              </p>
      ...
      <div className="w-full flex-1 mt-8">
        ...
        <div className="mx-auto max-w-xs">
          ...
          { !otpSent && 
            ...
            <a href="/login" className="border-b text-[#00A674] font-bold">
             Login
            </a>
          </p>)
        }
        <br/>
          <OtpHandler setOtpSent={setOtpSent} otpSent={otpSent}/>
        </div>
      </div>
    </div>
  </div>
